...
int main()
{
  cout << "########## Uso directo de objetos, sin polimorfismo ##########" << endl;
  Carro carro(120, "carro chevrolet");
  Bicicleta bicicleta(30, "bici eléctrica");
  bicicleta.desdoblar();
  if(bicicleta.estaDoblada())
    cout << "La bici está doblada" << endl;
  else
    cout << "La bici está desdoblada" << endl;
  ...
  cout << "########## Uso de objetos por medio de un puntero con polimorfismo ##########" << endl;
...
//  misVehiculos[1]->doblar();   // Las funciones nuevas no funcionan polimórficamente
