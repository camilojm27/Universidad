...
int main()
{
  ListaEnlazada *listaComun;
  {
    ...
    listaComun = lista.shallowCopy();  // Cede propiedad
    ...
    // AQUI NO DEBEN IR LAS DOS SIGUIENTES LINEAS:
    //  delete listaComun; // Debe destruirse la ùltima, porque es la propietaria
    //  listaComun = 0;
  ...
  cout << "La lista copiada superficialmente: ";
  listaComun->imprimir();
  // AQUÍ SÍ:
  delete listaComun; // Debe destruirse la ùltima, porque es la propietaria
  listaComun = 0;
