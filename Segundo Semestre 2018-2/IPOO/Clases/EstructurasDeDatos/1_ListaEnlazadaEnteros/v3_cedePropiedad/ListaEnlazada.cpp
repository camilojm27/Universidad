...
ListaEnlazada *ListaEnlazada::shallowCopy()
{
  ...
  nueva->soyPropietarioDelPrimerElemento = true;  // La nueva lista es propietaria de ElementoListaEnlazada
  this->soyPropietarioDelPrimerElemento = false;  // La lista original no es propietaria de ElementoListaEnlazada
  return nueva; 
}
